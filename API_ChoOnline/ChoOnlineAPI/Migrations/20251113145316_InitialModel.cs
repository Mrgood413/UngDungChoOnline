        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_User_TrustScore", "TrustScore >= 0 AND TrustScore <= 100");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Admin_Actions", x => x.ActionId);
                    table.ForeignKey(
                        name: "FK_Admin_Actions_Users_AdminId",
                        column: x => x.AdminId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Trust_History", x => x.HistoryId);
                    table.ForeignKey(
                        name: "FK_Trust_History_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ban_Records", x => x.BanId);
                    table.ForeignKey(
                        name: "FK_Ban_Records_Reports_ReportId",
                        column: x => x.ReportId,
                        principalTable: "Reports",
                        principalColumn: "ReportId",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Ban_Records_Users_BannedBy",
                        column: x => x.BannedBy,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Admin_Actions_AdminId",
                table: "Admin_Actions",
                column: "AdminId");

            migrationBuilder.CreateIndex(
                name: "IX_Admin_Actions_TargetUserId",
                table: "Admin_Actions",
                column: "TargetUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Ban_Records_BannedBy",
                table: "Ban_Records",
                column: "BannedBy");

            migrationBuilder.CreateIndex(
                name: "IX_Ban_Records_ReportId",
                table: "Ban_Records",
                column: "ReportId");
